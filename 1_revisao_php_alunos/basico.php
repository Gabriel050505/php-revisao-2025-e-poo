...
// A função ucfirst() no PHP serve para converter a primeira 
// letra de uma string para maiúscula e deixar o restante das 
// letras em minúscula.

// No entanto, ucfirst() só altera a primeira letra da string.
// Se você precisar de uma formatação mais complexa (por 
// exemplo, deixar todas as palavras com a primeira letra
...
// Condicional normal (maior porém mais fácil)
if ($temperatura < 15) {
    echo "Está frio! <br>";
...
// Condição com ternário (mais difícil porém simples)
echo ($temperatura < 15) ? "Está frio! <br>" : (($temperatura >= 15 && $temperatura < 25) ? "A temperatura está agradável. <br>" : "Está calor! <br>");


// Switch case (para facilitar em casos que precisariam de muitos "if"s)
$dia_semana = date("w");
echo "Hoje é: ";
...
foreach ($linguagens AS $inside => $linguagem) {
    echo "Linguagems $indice: $linguagem <br>";
}
